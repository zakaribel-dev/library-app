...
const AdvancedSearchPage = () => {
    ...
    const {
        data: results = [],
        isFetching,
        refetch, // je sais refetch c'est bizarre alors que ligne 21 on dit ne fetch pas tant que je l'ai pas fait manuellement..
// en fait refetch est propre à useQuery il considère que même 
// si t'as pas fetch c'est quand même fetch parce que vu qu'on stocke en cache la donnée est réutilisable
    } = useQuery({ //  go voir https://tanstack.com/query/v4/docs/framework/react/reference/useQuery
        queryKey: ["searchBooks", form], // la clé du cache
        queryFn: () => searchBooks(form),
        enabled: false,// ici ça veut dire ne fais pas le fetch au rendu du composant,
